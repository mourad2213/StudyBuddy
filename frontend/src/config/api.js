...
const API_CONFIG = {
  ...
  MATCHING_SERVICE: import.meta.env.VITE_MATCHING_URL || "http://localhost:4002/graphql",
  MESSAGING_SERVICE: import.meta.env.VITE_MESSAGING_URL || "http://localhost:4003/graphql",
  AVAILABILITY_SERVICE: import.meta.env.VITE_AVAILABILITY_URL || "http://localhost:4004/graphql",
};
